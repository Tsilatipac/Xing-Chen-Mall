...
import com.lcy.xingchenmall.search.service.ProductSaveService;
...
public class ProductSaveServiceImpl implements ProductSaveService {
    ...
    public boolean productStatusUp(List<SkuEsModel> skuEsModels) throws IOException {
        ...
        BulkResponse bulk = restHighLevelClient.bulk(bulkRequest, XingchenmallElasticConfig.COMMON_OPTIONS);
        //TODO 1、如果批量错误
